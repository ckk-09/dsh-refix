...
const REFIX_V6 = readFileSync(new URL('../versions/refix-v1.06.js', import.meta.url), 'utf8')
const REFIX_V7 = readFileSync(new URL('../versions/refix-v1.1-pre2.js', import.meta.url), 'utf8')
