/**
 * dsh-refix v1.2.0 — DSH **静态**（profile 层）构建。自动生成，请勿手改。
 *
 *   生成器  deploy/static/build-static.mjs
 *   生成源  versions/refix-v1.07.js
 *   源 sha256  8d13fec59465660ae5eb38d3e00ecda19b8d8b7002b6780b9843cf764dadeb88
 *   插件自报版本  p3.4（V1.07）
 *   静态包发布  V1.2（package 1.2.0）
 *
...
// 【定版 V1.07】稳定版发布线 V1.0x（原开发代号 v7 / p3.4）——V1.0x 最终版，当前推荐挂载
